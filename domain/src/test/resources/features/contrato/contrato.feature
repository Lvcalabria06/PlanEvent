Feature: Gestão de contratos e fornecedores do evento

  Como gestor
  Quero cadastrar, editar, visualizar e encerrar contratos vinculados a fornecedores ativos
  ...
  Scenario: Cadastrar contrato com sucesso
    ...
    And existe um fornecedor ativo válido para contrato
  ...
  Scenario: Impedir cadastro com fornecedor inativo
    Given existe um evento válido para contrato
    And existe um fornecedor inativo para contrato
    When eu tentar cadastrar um contrato completo
    Then o sistema deve impedir o cadastro do contrato

  Scenario: Impedir cadastro com fornecedor inexistente
    Given existe um evento válido para contrato
    And não existe fornecedor válido para contrato
    When eu tentar cadastrar um contrato completo
    Then o sistema deve impedir o cadastro do contrato
