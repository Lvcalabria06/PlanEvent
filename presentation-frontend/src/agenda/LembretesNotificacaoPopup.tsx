...
interface LembretesNotificacaoPopupProps {
  ...
  onClose: () => void
  onVerAgenda: () => void
  onEditar?: (lembrete: LembreteAgenda) => void
            ...
            return (
              <div key={l.id} className="lembrete-item lembrete-item-dropdown">
                ...
                <div className="lembrete-item-body">
                  ...
                  {(onEditar || onExcluir) && (
                    <div className="lembrete-item-actions" style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem' }}>
                      {onEditar && (
                        <button type="button" className="btn-editar-link" onClick={() => onEditar(l)}>
                          Editar
                        </button>
                      )}
                      {onExcluir && (
